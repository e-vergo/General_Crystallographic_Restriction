...
- **[Blueprint](https://e-vergo.github.io/General_Crystallographic_Restriction/blueprint/)** - Side-by-side LaTeX and Lean display with interactive hovers and dependency graphs
- **[Paper](https://e-vergo.github.io/General_Crystallographic_Restriction/paper/)** - ar5iv-style mathematical exposition with links to formal proofs

Both are generated by the [Side-by-Side Blueprint](https://github.com/e-vergo/Dress) toolchain.
...
This project showcases experimental Lean documentation tooling that displays formal proofs alongside LaTeX theorem statements.

| Component | Purpose |
|-----------|---------|
| [Dress](https://github.com/e-vergo/Dress) | Artifact generation during elaboration |
| [LeanArchitect](https://github.com/e-vergo/LeanArchitect) | `@[blueprint]` attribute for marking declarations |
| [Runway](https://github.com/e-vergo/Runway) | Site generator and dashboard |
